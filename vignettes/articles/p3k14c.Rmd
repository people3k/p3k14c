...
ggplot2::ggsave(
  filename = "figures/Figure5_regional_quality_assessment.pdf",
  width = 7,
  height = 9/2,
  units = "in"
)
...
ggplot2::ggsave(
  filename = "figures/Figure5_regional_quality_assessment.png",
  width = 7,
  height = 9/2,
  units = "in"
)
...
conus_dates_sites_sma <-
  conus_dates_sites %>%
  dplyr::group_by(Scale, `Site Type`) %>%
  dplyr::summarise(
    sma = list({
      smatr::sma(log10(`Dates density`) ~ log10(`Sites density`)) %$%
        tibble::tibble(elevation = coef[[1]]$`coef(SMA)`[[1]],
...
conus_dates_sites %>%
  ...
  facet_grid(Scale ~ `Site Type`)

ggplot2::ggsave(
  filename = "figures/Figure7_conus_bias.pdf",
  width = 7,
  height = 9/2,
  units = "in"
)
...
ggplot2::ggsave(
  filename = "figures/Figure7_conus_bias.png",
  width = 7,
  height = 9/2,
  units = "in"
)
